...
def showMenu(restaurant_id):
    ...
    creator = getUserInfo(restaurantToShowMenu.user_id)
...
def newMenuItem(restaurant_id):
    ...
    if restaurantToShowMenu.user_id != login_session['user_id']:
...
def editMenuItem(restaurant_id, menu_item_id):
    ...
    if parentRestaurant.user_id != login_session['user_id']:
